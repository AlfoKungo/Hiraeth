...
namespace SRL {
	namespace Checks
	{
		static void create_monster_data()
		{
			...
			{
				SRL::MonsterData data{ {"Slime", 5, 4444, 400, 400, 250, 250, 15,
					40, 40, 40, 30, 30, 20, 20, 10, 100},
					0,
					{
						{Behave_walk, 0},
						{Behave_stop, 0},
				...
				std::ofstream map_data_file("data/monster/monster_data/0.json", std::ios::out);
				cereal::JSONOutputArchive arout(map_data_file);
				arout(CEREAL_NVP(data));
			}

			{
				SRL::MonsterData data{ {"Green Mushroom", 5, 4444, 1000, 1000, 250, 250, 15,
					40, 40, 40, 30, 30, 20, 20, 10, 100},
					1,
					{
						{Behave_walk, 0},
				...
				std::ofstream map_data_file("data/monster/monster_data/1.json", std::ios::out);
				cereal::JSONOutputArchive arout(map_data_file);
				arout(CEREAL_NVP(data));
			}
