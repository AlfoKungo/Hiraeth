...
namespace hiraeth {
	namespace ui {
		...
		{
			m_Group.clear();
			m_Group.add(new graphics::Sprite(0, 0, graphics::TextureManager::Load("Assets/UI/Stats/Stat.main.backgrnd.png")));
			m_Group.add(new graphics::Sprite(6, 5, graphics::TextureManager::Load("Assets/UI/Stats/Stat.main.backgrnd2.png")));
			m_Group.add(new graphics::Sprite(7, 114, graphics::TextureManager::Load("Assets/UI/Stats/Stat.main.backgrnd3.png")));
			//m_Group.add(new graphics::Sprite(120, 120, graphics::TextureManager::Load("Stat.main.BtAuto.normal.1.png")));
			m_Group.add(new graphics::SpritedRenderable(maths::vec3(120, 120, 0), 4, 0.15f, true, graphics::TextureManager::Load("Assets/UI/Stats/Stat.main.BtAuto.normal.png"), maths::vec2(0)));
