...
namespace hiraeth {
	namespace ui {
		...
		void MainUi::fill_stats_group()
		{
			...
			m_Hp = new graphics::Sprite(3, 19, relativeHp * 139, 12, 0xff0000ff);
			...
			m_Mp = new graphics::Sprite(174, 19, relativeMp * 139, 12, 0xfff5b626);
			...
			m_Exp = new graphics::Sprite(3, 3, relativeExp * 310, 12, 0xff18dba9);
